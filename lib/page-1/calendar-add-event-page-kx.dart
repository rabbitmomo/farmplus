        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              padding:
                  EdgeInsets.fromLTRB(22 * fem, 24 * fem, 24 * fem, 24 * fem),
              width: double.infinity,
              height: 78 * fem,
              decoration: const BoxDecoration(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    // group43ZXd (156:569)
                    margin:
                        EdgeInsets.fromLTRB(0 * fem, 1 * fem, 0 * fem, 1 * fem),
                    width: 61 * fem,
              ...
              child: Column(
                ...
                children: [
                    ...
                    child: Stack(
                      children: [
                            ...
                            child: Row(
                              ...
                              children: [
                                Container(
                                  ...
                                  padding: EdgeInsets.fromLTRB(7.75 * fem,
                                      11.5 * fem, 14 * fem, 10.5 * fem),
                                  height: double.infinity,
                                  decoration: BoxDecoration(
                                    border: Border.all(
                                        color: const Color(0xffc7c7c7)),
                        ...
                        Positioned(
                          ...
                          child: Container(
                            padding: EdgeInsets.fromLTRB(
                                7.75 * fem, 11.5 * fem, 7.75 * fem, 10.5 * fem),
                            width: 155 * fem,
                            height: 42 * fem,
                            decoration: BoxDecoration(
                              border:
                  ...
                  Container(
                    // group508BH (160:876)
                    padding: EdgeInsets.fromLTRB(
                        16 * fem, 11.5 * fem, 17 * fem, 10.5 * fem),
                    width: double.infinity,
                    decoration: BoxDecoration(
                      border: Border.all(color: const Color(0xffc7c7c7)),
                      borderRadius: BorderRadius.circular(8 * fem),
