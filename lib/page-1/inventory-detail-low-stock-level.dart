...
class InventoryDetailLow extends StatelessWidget {
  const InventoryDetailLow({super.key});
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                margin:
                    EdgeInsets.fromLTRB(0 * fem, 0 * fem, 5 * fem, 127 * fem),
              ...
              Container(
                // group35Z8K (355:150)
                margin:
                    EdgeInsets.fromLTRB(11 * fem, 0 * fem, 16 * fem, 0 * fem),
                width: double.infinity,
                height: 50 * fem,
