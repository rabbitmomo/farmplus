      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Container(
              // topth5 (210:1302)
              margin: EdgeInsets.fromLTRB(9*fem, 0*fem, 12*fem, 18*fem),
              width: double.infinity,
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
            ...
            Container(
              ...
              padding: EdgeInsets.fromLTRB(13*fem, 12*fem, 62*fem, 11*fem),
              width: double.infinity,
              height: 118*fem,
              decoration: BoxDecoration (
                color: Color(0xffffffff),
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Container(
                                // vector4ST (210:1296)
                                margin: EdgeInsets.fromLTRB(0.76*fem, 0*fem, 0*fem, 0*fem),
                                width: 10.76*fem,
                                height: 13*fem,
                                child: Image.asset(
                              ...
                              Container(
                                // vectorFWw (210:1291)
                                margin: EdgeInsets.fromLTRB(0.96*fem, 0*fem, 0*fem, 0*fem),
                                width: 8.96*fem,
                                height: 13*fem,
                                child: Image.asset(
              ...
              child: Row(
                ...
                children: [
                    ...
                    child: Stack(
                      children: [
                        Positioned(
                          ...
                          top: 0*fem,
                          child: Container(
                            padding: EdgeInsets.fromLTRB(57*fem, 8*fem, 57*fem, 8*fem),
                            width: 152*fem,
                            height: 100*fem,
                            decoration: BoxDecoration (
                              color: Color(0xffffffff),
                  ...
                  Container(
                    ...
                    padding: EdgeInsets.fromLTRB(39*fem, 8*fem, 40*fem, 8*fem),
                    width: 152*fem,
                    height: double.infinity,
                    decoration: BoxDecoration (
                      color: Color(0xffffffff),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Container(
                    // group83Y79 (210:1374)
                    margin: EdgeInsets.fromLTRB(13*fem, 0*fem, 14.5*fem, 10*fem),
                    width: double.infinity,
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                  ...
                  Container(
                    ...
                    padding: EdgeInsets.fromLTRB(13*fem, 15*fem, 13*fem, 14*fem),
                    width: double.infinity,
                    height: 244*fem,
                    decoration: BoxDecoration (
                      color: Color(0xffffffff),
