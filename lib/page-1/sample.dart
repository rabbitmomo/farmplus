        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 390*fem, 66*fem),
              width: double.infinity,
              height: 661*fem,
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    padding: EdgeInsets.fromLTRB(0*fem, 43*fem, 65*fem, 42*fem),
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    padding: EdgeInsets.fromLTRB(0*fem, 48*fem, 130*fem, 47*fem),
                    height: double.infinity,
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
