      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Container(
              // topeVV (68:269)
              margin: EdgeInsets.fromLTRB(9*fem, 0*fem, 100*fem, 22.5*fem),
              width: double.infinity,
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Container(
                    // date1iGP (68:268)
                    margin: EdgeInsets.fromLTRB(9*fem, 0*fem, 4*fem, 7*fem),
                  ...
                  Container(
                    ...
                    padding: EdgeInsets.fromLTRB(3*fem, 11*fem, 0*fem, 0*fem),
                    width: double.infinity,
                    child: Column(
            ...
            Container(
              // group35jQs (102:584)
              margin: EdgeInsets.fromLTRB(29*fem, 0*fem, 24*fem, 0*fem),
              width: double.infinity,
              height: 50*fem,
              decoration: BoxDecoration (
