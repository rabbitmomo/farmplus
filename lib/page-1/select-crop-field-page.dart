        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              padding:
                  EdgeInsets.fromLTRB(26 * fem, 20 * fem, 24 * fem, 7 * fem),
              width: double.infinity,
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        GestureDetector(
                          onTap: () {
                            Navigator.pushReplacementNamed(context,'/home'); // This will navigate back
                          },
                          child: Container(
                            // vectorrZD (181:1137)
                            margin: EdgeInsets.fromLTRB(
            ...
            Container(
              // group64fKd (181:1161)
              padding: EdgeInsets.fromLTRB(
                  21 * fem, 24.5 * fem, 108 * fem, 29.5 * fem),
              width: double.infinity,
              height: 140 * fem,
              decoration: BoxDecoration(
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: TextButton(
                      ...
                      child: Container(
                        padding: EdgeInsets.fromLTRB(
                            21 * fem, 26.5 * fem, 95 * fem, 27.5 * fem),
                        width: 360 * fem,
                        height: 140 * fem,
                        decoration: BoxDecoration(
                          border: Border.all(color: const Color(0xffeaeaea)),
            ...
            Container(
              ...
              padding: EdgeInsets.fromLTRB(
                  16 * fem, 26.5 * fem, 95 * fem, 27.5 * fem),
              width: double.infinity,
              height: 140 * fem,
              decoration: BoxDecoration(
                border: Border.all(color: const Color(0xffeaeaea)),
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(
                        0 * fem, 0 * fem, 21.81 * fem, 0 * fem),
                    padding: EdgeInsets.fromLTRB(
                        37 * fem, 17 * fem, 70.47 * fem, 16.86 * fem),
                    width: 242.97 * fem,
                    height: double.infinity,
                    decoration: BoxDecoration(
                  ...
                  TextButton(
                    ...
                    child: Container(
                      padding: EdgeInsets.fromLTRB(
                          18.69 * fem, 18 * fem, 18.69 * fem, 18 * fem),
                      height: double.infinity,
                      decoration: BoxDecoration(
